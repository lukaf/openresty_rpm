...
%changelog
* Wed Apr 10 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (8e57e25) bumped version to 1.2.7.5; updated tests to reflect recent changes.

* Wed Apr 10 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (f5f2d67) upgraded ngx_lua to 0.7.20.

* Tue Apr 9 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (49d9d9b) nginx-1.2.7-upstream_truncation.patch: worked around an issue in ngx_event_pipe_copy_input_filter because it does not set p->upstream_done when p->length <= 0 like ngx_http_proxy_copy_filter.

* Mon Apr 8 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (13efb24) bugfix: ngx_uwsgi and ngx_scgi did set u->length but not u->pipe->length, thus leading to truncation false positives.

* Sun Apr 7 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (3be0b7f) bugfix: upstream_truncation.patch: 1. 504 error code in ngx_http_upstream_finalize_request resulted in calling special response handler even when the response header has been sent; 2. use 502 status code in ngx_http_upstream_finalize_request when upstream data truncation happens.

* Fri Apr 5 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (5fb8647) renamed upstream-truncation.patch to upstream_trauncation.patch and also added a test for the case that r->upstream->pipe is NULL.

* Fri Apr 5 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (e7053c9) updated the dtrace patch to make the stap function ngx_chain_dump() print out info about the "last_buf" and "last_in_chain" flags in bufs.

* Fri Apr 5 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (042e2fd) renamed the "nonbuffered-upstream-truncation" patch to "upstream-truncation" patch; also fixed issues with chunked upstream response bodies. thanks Andy Yuan for reporting this issue in #24.

* Thu Apr 4 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (1d90953) upgraded lua-resty-mysql to 0.13.

* Wed Mar 27 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (d54e2dc) upgraded ngx_echo to 0.45, ngx_drizzle to 0.1.5, ngx_lua to 0.7.19, and lua-resty-memcached to 0.11.

* Mon Mar 25 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (009db17) updated tests to reflect recent changes.

* Mon Mar 25 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (7e359ff) upgraded ngx_lua to 0.7.18, ngx_echo to 0.44, ngx_redis2 to 0.10, and lua-resty-upload to 0.08; also bumped version to 1.2.7.3.

* Fri Mar 22 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (9f52ad4) applied the variables_in_redis_pass patch to ngx_redis 0.3.6 to allow use of nginx variables in the redis_pass directive.

* Thu Mar 21 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (a925be0) bugfix: applied Lanshun Zhou's run_posted_requests_in_resolver patch to the Nginx core: http://mailman.nginx.org/pipermail/nginx-devel/2013-March/003476.html

* Wed Mar 20 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (d91993f) upgraded ngx_lua to 0.7.18rc2.

* Sat Mar 16 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (0a9a701) Merge branch 'master' of github.com:agentzh/ngx_openresty

* Sat Mar 16 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (c9f5ca8) upgraded ngx_lua to 0.7.17 and ngx_echo to 0.43. also applied the official hotfix #1 patch for LuaJIT 2.0.1.

* Mon Mar 11 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (7495a32) upgraded ngx_lua to 0.7.17 and ngx_echo to 0.43.

* Sat Feb 23 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (9e944b8) bumped version to 1.2.7.1 and upgraded ngx_lua to 0.7.16.

* Wed Feb 20 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (b259f33) upgraded LuaJIT to 2.0.1.

* Mon Feb 18 2013 agentzh (Yichun Zhang) <agentzh@gmail.com>
- (db97803) upgraded the nginx core to 1.2.7.
